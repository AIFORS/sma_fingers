...
All the environments are registered in the `three_fingers` extension. They start
...
import three_fingers.tasks  # noqa: F401


def main():
    """Print all environments registered in `three_fingers` extension."""
