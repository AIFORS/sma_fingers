...
parser.add_argument(
    "--checkpoint",
    type=Path,
    default=Path("/home/vsivtsov/Documents/kinova_isaac/logs/rsl_rl/three_fingers_grasp/2026-03-10_20-16-40/model_9050.pt"),
...
def main():
    ...
    log_path = Path("outputs/three_fingers_rl_policy.csv")
    ...
    if args_cli.video:
        video_folder = Path("outputs/videos/three_fingers_rl_policy")
    ...
    try:
        ...
        if action_dim >= 3 and policy_input_dim >= 3:
            ...
            plot_rl_tracking(
                Path("outputs/three_fingers_rl_policy_tracking.png"),
                times_arr,
                actions_denorm,
                obs_denorm,
                actions_first3,
